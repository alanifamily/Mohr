...
sigma_x_display=st.sidebar.metric("$\sigma_x$ "+Unit ,value=sigma_x)
sigma_y_display=st.sidebar.metric("$\sigma_y$ "+Unit ,value=sigma_y)
tau_xy_display=st.sidebar.metric("$\\tau_xy$ "+Unit ,value=tau_xy)
...
p_stress1_display=st.sidebar.metric("$\sigma_1$ "+Unit ,value=p_stress1)
p_stress1_input=st.number_input("$\sigma_1$",-300.00,300.00,value=45.0)

p_stress2_display=st.sidebar.metric("$\sigma_2$ "+Unit ,value=p_stress2)
p_stress2_input=st.number_input("$\sigma_2$",-300.00,300.00,value=45.0)

if p_stress1_input==p_stress1 and p_stress2_input==p_stress2:
    st.balloons()
...
# fig.update_layout(xaxis_title='test '+Unit, yaxis_title='test '+Unit)
